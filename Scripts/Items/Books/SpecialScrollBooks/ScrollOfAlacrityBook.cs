...
namespace Server.Items
{
    ...
    public class ScrollOfAlacrityBook : BaseSpecialScrollBook
    {
        ...
        public static void Initialize()
        {
            ...
            _SkillInfo[SkillCat.Combat] = new List<SkillName>() { SkillName.Anatomy, SkillName.Archery, SkillName.Fencing, SkillName.Healing, SkillName.Macing, SkillName.Parry, SkillName.Swords, SkillName.Tactics, SkillName.Wrestling };// remove , SkillName.Throwing , SkillName.Focus
            ...
            _SkillInfo[SkillCat.Magic] = new List<SkillName>() {SkillName.EvalInt, SkillName.Magery, SkillName.Meditation, SkillName.MagicResist, SkillName.SpiritSpeak };//remove SkillName.Spellweaving  SkillName.Bushido, SkillName.Chivalry, , SkillName.Mysticism, SkillName.Necromancy, SkillName.Ninjitsu SkillName.Imbuing, 
