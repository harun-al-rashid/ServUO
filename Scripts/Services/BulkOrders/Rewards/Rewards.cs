    ...
    public sealed class TailorRewardCalculator : RewardCalculator
    {
        public TailorRewardCalculator()
        {
            if (BulkOrderSystem.NewSystemEnabled)
            {
                ...
                RewardCollection.Add(new BODCollectionItem(0xF9D, 1063550, CraftResources.GetHue(CraftResource.Dullhide), 350, RunicKit, 1));
                ...
                RewardCollection.Add(new BODCollectionItem(0xF9D, 1063551, CraftResources.GetHue(CraftResource.Shadowhide), 450, RunicKit, 2));
                RewardCollection.Add(new BODCollectionItem(0x14F0, 1157119, 0x481, 500, PowerScroll, 10));
                RewardCollection.Add(new BODCollectionItem(0xF9D, 1063552, CraftResources.GetHue(CraftResource.Copperhide), 550, RunicKit, 3));
                ...
                RewardCollection.Add(new BODCollectionItem(0xF9D, 1063553, CraftResources.GetHue(CraftResource.Bronzehide), 650, RunicKit, 4));
                RewardCollection.Add(new BODCollectionItem(0xF9D, 1063554, CraftResources.GetHue(CraftResource.Goldenhide), 800, RunicKit, 5));
                RewardCollection.Add(new BODCollectionItem(0x14F0, 1157121, 0x481, 650, PowerScroll, 20));
                RewardCollection.Add(new BODCollectionItem(0xF9D, 1063555, CraftResources.GetHue(CraftResource.Rosehide), 1000, RunicKit, 6));
                RewardCollection.Add(new BODCollectionItem(0xF9D, 1063556, CraftResources.GetHue(CraftResource.Verehide), 1100, RunicKit, 7));
                RewardCollection.Add(new BODCollectionItem(0xF9D, 1063557, CraftResources.GetHue(CraftResource.Valehide), 1200, RunicKit, 8));
            }
            else
            {
                this.Groups = new RewardGroup[]
        ...
        {
            new int[] { 1141, 1155, 1157, 1158, 1160, 1175, 1193, 1196, 1254, 1310, 1425, 1501, 1509, 1646, 1652, 2118, 2122, 2124, 2125, 2224, 2422, 1105, 1128, 2128 },
            new int[] { 1782, 1788, 1790, 2241, 2263, 2599, 2615, 2635, 2767, 2897, 2843, 2096, 2087 },
            new int[] { 2817, 1918, 2765, 2915, 2906, 2875 },
            new int[] { 1779, 1909, 2091, 2099, 2085, 2092, 2089, 2796, 2338, 1182, 1183 },
            new int[] { 2227, 1495, 1496, 1382, 1494, 2246, 1381, 2255, 2877, 1384, 1462, 2173, 2903, 2808, 1952 },
            new int[] { 1483, 1476, 1479, 2916, 2251, 2664, 2342, 1967, 1956, 2346, 1957, 1557, 1571, 1574, 2284, 2074, 1181, 1180, 1179, 1184 },
        };
